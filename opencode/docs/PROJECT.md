...
| Documento | Descrição |
|-----------|-----------|
| [app/AGENTS.md](../../app/AGENTS.md) | App Router |
| [components/AGENTS.md](../../components/AGENTS.md) | Componentes UI e Admin |
| [lib/AGENTS.md](../../lib/AGENTS.md) | Utils, Supabase, WhatsApp |
| [context/AGENTS.md](../../context/AGENTS.md) | Carrinho (CartContext) |
| [hooks/AGENTS.md](../../hooks/AGENTS.md) | Custom hooks |
| [types/AGENTS.md](../../types/AGENTS.md) | Definições TypeScript |
| [tests/AGENTS.md](../../tests/AGENTS.md) | Infraestrutura de testes |
| [supabase/AGENTS.md](../../supabase/AGENTS.md) | Schema e migrations |
...
│  Equipe: 6 funcionários (2 cozinha, 4 atendimento)         │
...
3. Simples de usar — "Não preciso ser expert em tecnologia."
...
- Usa Instagram e redes para marketing
...
|----------|-----------|----------------------|
| **SDD** | Specification-Driven Development | [opencode/rules/AGENTS.md](./rules/AGENTS.md) |
| **CI/CD** | GitHub Actions (lint, build, test) | [.github/workflows/ci.yml](../../.github/workflows/ci.yml) |
| **Post-Archive** | Revisão pós-archive | [opencode/skills/post-archive-review/SKILL.md](../../opencode/skills/post-archive-review/SKILL.md) |
| **Quality Gates** | Pre-commit checks | [opencode/rules/AGENTS.md](./rules/AGENTS.md) - Gates de Qualidade |
...
```
prompt → proposal → spec → design → tasks → implementation → verification → archive → post-archive
```

#### Passo a Passo

1. **prompt** - Conceber ideia
2. **proposal** - Proposta formal com scope
3. **spec** - Requisitos RFC 2119
4. **design** - Design técnico
5. **tasks** - Lista de tarefas
6. **implementation** - Código + Testes + Documentação
7. **verification** - Compliance report
8. **archive** - Consolidado e arquivado
9. **post-archive** - Revisão obrigatória pós-archive
...
| post-archive | Revisão de código, docs e testes | Revisor |
...
```bash
mkdir -p opencode/changes/minha-mudanca
```

2. Usar skill `sdd-init` (Orchestrator)

3. Seguir fluxo SDD: `proposal → spec → design → tasks → implementation → verification → archive → post-archive`

4. Cada fase tem artefatos específicos:

| Fase | Artefato | Localização |
|------|----------|-------------|
| proposal | `proposal.md` | `opencode/changes/{nome}/` |
| spec | `spec.md` | `opencode/changes/{nome}/` |
| design | `design.md` | `opencode/changes/{nome}/` |
| tasks | `tasks.md` | `opencode/changes/{nome}/` |
