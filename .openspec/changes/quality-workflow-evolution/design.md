...
A mudança consiste em evoluir o workflow SDD do MenuLink para incorporar práticas de qualidade (TDD, BDD, ATDD, DDD) desde a fase de design, adicionar uma etapa inicial de concepção (PRB.md), e garantir atualização obrigatória de documentação dos módulos afetados.
...
### Decision: Adicionar etapa PRB.md como porta de entrada

**Choice**: PRB.md como documento inicial conciso antes do proposal.md
...
**Rationale**: O PRB.md permite capturar a essência da ideia sem detalhar técnica. A análise posterior com PRD.md e codebase garante que a proposta seja fundamentada na realidade.
...
| Arquivo | Modificação |
|---------|-------------|
| `AGENTS.md` | Atualizar fluxo SDD para incluir PRB.md, análise e regra de proximidade |
