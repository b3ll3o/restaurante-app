...
|-----------|-----------|--------|
| REQ-QWF-001 | Etapa PRB.md | ✅ Implementado - Template criado |
...
|----------|-----------|--------|
| CA-QWF-001 | Template PRB.md | ✅ Template com campos obrigatórios |
...
|---------|--------|-----------|
| PRB.md como porta de entrada | ✅ | Template criado, fluxo documentado |
...
- **3 templates** OpenSpec (PRB, design, tasks)
