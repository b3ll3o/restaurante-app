...
### In Scope
- Template PRD.md com estrutura de PRB (Product Requirement Brief)
...
4. **Fluxo SDD atualizado**: PRB → Análise → proposal → spec → design → tasks → implementation → verification → archive
